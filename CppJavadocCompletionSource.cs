namespace CppJavadoc
{
    ...
    public class CppJavadocCompletionSource : ICompletionSource
    {
        private CppJavadocCompletionSourceProvider m_sourceProvider;
        private ITextBuffer m_textBuffer;
        private List<Completion> m_compList = new List<Completion>();
        private bool m_isDisposed;
        
        public CppJavadocCompletionSource(CppJavadocCompletionSourceProvider sourceProvider, ITextBuffer textBuffer)
        {
        ...
        void ICompletionSource.AugmentCompletionSession(ICompletionSession session, IList<CompletionSet> completionSets)
        {
            try
            {
                ...
                if (m_textBuffer.ContentType.TypeName != CppJavadocCompletionCommandHandler.CppTypeName)
                {
                    return;
                }
